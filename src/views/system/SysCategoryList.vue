<template>
	<a-card :bordered="false">
		...
		<div class="btn-right">
			...
			<a-button style="background-color: #2c66f4" type="primary" icon="download" @click="handleExportXls('分类字典')">
				导出</a-button>
		...
		<!-- table区域-begin -->
		<div>
			<a-table :scroll='{y:500}' bordered ref="table" size="middle" rowKey="id" :columns="columns"
