		...
		<a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
			<a-card :bordered="false">
						...
						<a-row :gutter="24">
							<a-col :span="24">
								<a-form-item label="角色名称">
									<j-input placeholder="请输入角色名称" v-model="queryParam.roleName"></j-input>
								</a-form-item>
								<!--
              <a-col :md="11" :sm="12">
              ...
              -->
						...
						<!-- 操作按钮区域 -->
						<div class="btn-left">
							<a-button style="background-color: #2c66f4" @click="handleAdd" type="primary" icon="plus">
								新建角色</a-button>
							<!--<a-button style="background-color: #2c66f4" @click="handleEdit(model1)" type="primary" icon="plus">角色编辑</a-button>-->
							<!-- <a-upload
						    name="file"
						  ...
						  <a-button style="background-color: #2c66f4" type="primary" icon="download" @click="handleExportXls('角色管理')">导出</a-button> -->
						</div>
				...
				<div class="ant-alert ant-alert-info" style="margin-bottom: 16px">
					...
					<a><b>{{ selectedRowKeys1.length }}</b></a>项
		...
		<a-col :md="rightColMd" :sm="24" v-if="this.rightcolval == 1">
			<a-card :bordered="false">
						...
						<a-row :gutter="24">
							...
							<span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
								<a-col :md="9" :sm="24">
									...
									<a-button type="primary" @click="searchReset2" icon="reload"
				...
				<div class="table-operator" :md="24" :sm="24">
					...
					<a-button @click="handleAddUserRole" type="primary" icon="plus" style="margin-top: 16px">已有用户
					</a-button>
				...
				<div>
					<a-table :scroll="{ y: 500}" ref="table2" bordered size="middle" rowKey="id" :columns="columns2"
