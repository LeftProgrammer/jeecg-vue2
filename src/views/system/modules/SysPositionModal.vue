<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="岗位编码">
          <a-input placeholder="请输入岗位编码" v-decorator="['code', validatorRules.code]" :read-only="readOnly" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="岗位名称">
          <a-input placeholder="请输入岗位名称" v-decorator="['name', validatorRules.name]" />
        </a-form-item>
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        name: { rules: [{ required: true, message: '请输入岗位名称' }] },
