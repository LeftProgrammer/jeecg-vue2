...
<script>
import { createOfficeFile, editOfficeFile, previewOfficeFile } from '@api/onlyoffice.js'
...
export default {
  ...
  methods: {
        ...
        var docConfig = {
          ...
          events: {
            onCollaborativeChanges: () => {
              console.log('onCollaborativeChanges', arguments)
            },
            onDocumentStateChange: () => {
              console.log('onDocumentStateChange', arguments)
            },
            onMetaChange: () => {
              console.log('onMetaChange', arguments)
            },
          },
        }
        console.log(JSON.stringify(docConfig))
        /* global DocsAPI */
        this.docEditor = new DocsAPI.DocEditor('placeholder', docConfig)
      })
    },
    /**
     * 判断当前平台
     ...
     */
    editDoc() {
      var previewUrl = '' // getFileAccessHttpUrl(this.fileInfo.fileUrl)
      let data = {
        id: this.fileInfo.id,
        previewUrl: previewUrl,
        filePath: this.fileInfo.fileUrl,
      }
