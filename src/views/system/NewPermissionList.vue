<template>
	<a-card :bordered="false">
		...
		<div class="btn-right">
			...
			<a-button style="background-color: #2c66f4" @click="batchDel" v-if="selectedRowKeys.length > 0" ghost type="primary" icon="delete">批量删除
			</a-button>
		</div>
        ...
        selectedRowKeys.length }}</a>项&nbsp;&nbsp;
			...
			<a-table :scroll='{y:550}' :columns="columns" size="middle" :pagination="false" :dataSource="dataSource"
				:loading="loading" @expand="expandSubmenu" :expandedRowKeys="expandedRowKeys"
