  ...
  export default {
    ...
    methods:{
      ...
      handleApplyRequest(formData){
        this.customBeforeSubmit(formData).then(()=>{
      ...
      clearSubRows(subKey){
        ...
        let rows = this.$refs[subKey][0].rows
        //update-begin-author:end date:20201105 for:LOWCOD-987 【online】js增强的问题--删除数据时获取所有数据
