...
export const constantRouterMap = [
    ...
    children: [
      {
        ...
        name: 'login',
        // 性能优化：路由按需加载
        component: resolve => require.ensure([], () => resolve(require('@/views/user/Login')))
      ...
      },
      {
        ...
        name: 'registerResult',
        component: resolve => require.ensure([], () => resolve(require('@/views/user/register/RegisterResult')))
        // component: () => import(/* webpackChunkName: "user" */ '@/views/user/register/RegisterResult')
      },
      {
        path: 'alteration',
        name: 'alteration',
        component: resolve => require.ensure([], () => resolve(require('@/views/user/alteration/Alteration')))
  ...
  
  {
    ...
    component: () =>
      import('@views/system/OnlyOffice.vue')
  },
